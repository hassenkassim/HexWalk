...
public class SoundManager : MonoBehaviour{
	...
	public void loadMusic(){
		...
		levelMusik [5] = (AudioClip)Resources.Load ("LevelMusik6");
		levelMusik [6] = (AudioClip)Resources.Load ("LevelMusik7");
		levelMusik [7] = (AudioClip)Resources.Load ("LevelMusik8");
		levelMusik [8] = (AudioClip)Resources.Load ("LevelMusik9");
		levelMusik [9] = (AudioClip)Resources.Load ("LevelMusik10");
